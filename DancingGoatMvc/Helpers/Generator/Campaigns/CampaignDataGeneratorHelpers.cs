...
namespace DancingGoat.Helpers.Generator
{
    ...
    internal static class CampaignDataGeneratorHelpers
    {
        ...
        public static void GenerateActivities(IEnumerable<ActivityDataParameters> activityDataParameters, CampaignInfo campaign, string type, ContactsIDData contactsIDs, ContactsUsIDData contactsUsIDs, int conversionItemID = 0, string activityUrl = null)
        {
            var nodeID = 0;
            var itemID = 0;
            ...
            foreach (var activityDataParameter in activityDataParameters)
            {
                ...
                {
                    GenerateFakeActivity(campaign.CampaignUTMCode, type, activityDataParameter, nodeID, itemID, campaign.CampaignSiteID, contactsIDs.GetNextContactID(), contactsUsIDs.GetNextContactUsID(), activityUrl);
                }
            }
        }


        private static void GenerateFakeActivity(string campaignUTMcode, string type, ActivityDataParameters activityDataParameter, int nodeID, int itemID, int siteID, int contactID, int contactUsID, string activityUrl = null)
        {
            ...
            var activity = new ActivityInfo
            {
                ...
                //ActivityContactUsID = contactUsID,
                ...
                //ActivityTitle = "GeneratedActivity_" + type + "_" + contactUsID
            };
