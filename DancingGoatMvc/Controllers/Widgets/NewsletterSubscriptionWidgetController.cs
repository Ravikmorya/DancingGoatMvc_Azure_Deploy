...
namespace DancingGoat.Controllers.Widgets
{
    ...
    public class NewsletterSubscriptionWidgetController : WidgetController<NewsletterSubscriptionProperties>
    {
        ...
        //private readonly IContactUsProvider contactUsProvider;
        ...
        /// /// <param name="contactUsProvider">Provider for contactus retrieving.</param>
            ...
            IComponentPropertiesRetriever componentPropertiesRetriever)
        {
            ...
            //this.contacUstProvider = contactUsProvider;
        ...
        public ActionResult Subscribe(SubscribeModel model)
        {
            ...
            //var contactUs = contactUsProvider.GetContactUsForSubscribing(model.Email);
            ...
            //if (!subscriptionService.IsMarketable(contactUs, newsletter))
            //{
            //    subscriptionService.Subscribe(contactUs, newsletter, NewsletterSubscriptionSettings);
        ...
        public ActionResult SubscribeAuthenticated()
        {
            ...
            //var contactUs = contactUsProvider.GetContactUsForSubscribing(user.Email, user.FirstName, user.LastName);
            var properties = componentPropertiesRetriever.Retrieve<NewsletterSubscriptionProperties>();
            var newsletter = newsletterInfoProvider.Get(properties.Newsletter, SiteContext.CurrentSiteID);
