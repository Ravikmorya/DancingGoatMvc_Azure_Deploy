...
namespace DancingGoat.Helpers.Generator
{
    ...
    internal class CampaignDataGenerator
    {
        ...
        public CampaignDataGenerator(ISiteInfo site, string contactFirstNamePrefix, string contactUsFirstNamePrefix)
        {
            mSite = site;
        ...
        private const int CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_CONTACTSUS_COUNT = 100;
        ...
        private const int CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_CONTACTSUS_COUNT = 0;
        ...
        public void Generate()
        {
            ...
            /* Generate activities */
            GenerateActivities(CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING, CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_HITS, CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_CONTACTS_COUNT, CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_CONTACTSUS_COUNT);
            GenerateActivities(CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED, CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_HITS, CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_CONTACTS_COUNT, CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_CONTACTSUS_COUNT);

            /* Generate activities  ADD CONTACTUS*/
            //GenerateActivities(CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING, CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_HITS, CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING_CONTACTSUS_COUNT);
            //GenerateActivities(CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED, CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_HITS, CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED_CONTACTSUS_COUNT);
        ...
        private void GenerateActivities(string campaignName, Dictionary<string, IEnumerable<ActivityDataParameters>> conversionHits, int contactsCount, int contactsUsCount)
        {
            ...
            var campaignContactsUsIDs = new ContactsUsIDData(mContactUsFirstNamePrefix, contactsUsCount);

            CampaignDataGeneratorHelpers.GenerateActivities(conversionHits[CONVERSION_PAGEVISIT_COFFEE_SAMPLES], campaignCafePromotion, PredefinedActivityType.PAGE_VISIT, campaignContactsIDs, campaignContactsUsIDs, activityUrl: DocumentURLProvider.GetAbsoluteUrl(pageVisitColombia));
            CampaignDataGeneratorHelpers.GenerateActivities(conversionHits[CONVERSION_FORMSUBMISSION_COFFEE_SAMPLE_LIST], campaignCafePromotion, PredefinedActivityType.BIZFORM_SUBMIT, campaignContactsIDs, campaignContactsUsIDs, formFreeSample.FormID);
            CampaignDataGeneratorHelpers.GenerateActivities(conversionHits[CONVERSION_PURCHASE], campaignCafePromotion, PredefinedActivityType.PURCHASE, campaignContactsIDs, campaignContactsUsIDs);
        }
