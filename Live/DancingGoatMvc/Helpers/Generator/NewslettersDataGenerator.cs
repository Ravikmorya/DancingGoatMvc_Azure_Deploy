...
namespace DancingGoat.Helpers.Generator
{
    ...
    internal class NewslettersDataGenerator
    {
        ...
        private const string NEWSLETTER_DANCING_GOAT = "DancingGoatMvcNewsletter";
        ...
        public void Generate()
        {
            ...
            //GenerateSubscribersForExistingContactsUs();
        ...
        //add contact us
        //private void GenerateSubscribersForExistingContactsUs()
        //{
        //    SubscribeContactUsWithEmailToNewsletter("monica.king@localhost.local", NEWSLETTER_DANCING_GOAT);
        //    SubscribeContactUsWithEmailToNewsletter("monica.king@localhost.local", NEWSLETTER_COFFEE101);
        //    SubscribeContactUsWithEmailToNewsletter("Dustin.Evans@localhost.local", NEWSLETTER_DANCING_GOAT);
        //    SubscribeContactUsUsWithEmailToNewsletter("Dustin.Evans@localhost.local", NEWSLETTER_COFFEE101);
        //    SubscribeContactUsWithEmailToNewsletter("Todd.Ray@localhost.local", NEWSLETTER_COFFEE101);
        //    SubscribeContactUsWithEmailToNewsletter("Stacy.Stewart@localhost.local", NEWSLETTER_COFFEE101);
        //    SubscribeContactUsWithEmailToNewsletter("Harold.Larson@localhost.local", NEWSLETTER_DANCING_GOAT);
        //}
        ...
        //Add contact us
        //private void SubscribeContactUsWithEmailToNewsletter(string contactUsEmail, string newsletterCodeName)
        //{
        //    //var contactUs = ContactUsInfoProvider.GetContactUsInfo(contactUsEmail);
        //    var newsletter = NewsletterInfo.Provider.Get(newsletterCodeName, site.SiteID);
        //    //var fullName = string.Format("{0} {1}", contactUs.ContactUsFirstName, contactUs.ContactUsLastName);

        //    //var subscriber = CreateSubscriber(contactUs.ContactUsEmail, contactUs.ContactUsFirstName, contactUs.ContactUsLastName, fullName, contactUs);
        //    //AssignSubscriberToNewsletter(newsletter.NewsletterID, subscriber);
        //    //mNewsletterActivityGenerator.GenerateNewsletterSubscribeActivity(newsletter, subscriber.SubscriberID, contactUs.ContactUsID, site.SiteID);
        //}
        ...
        private IList<SubscriberInfo> GenerateSubscribers()
        {
            ...
            for (int i = 0; i < subscriberNames.Count(); i++)
            {
                ...
                //var contactUs = CreateContactUs(subscriberData.FirstName, subscriberData.LastName, subscriberData.Email);
        ...
        private SubscriberInfo CreateSubscriber(string email, string firstName, string lastName, string fullName, ContactInfo contact)
        {
            ...
            subscriber = new SubscriberInfo
            {
                ...
                //SubscriberRelatedID = ContactUs.ContactUsID,
                SubscriberType = PredefinedObjectType.CONTACT,
                //SubscriberType = PredefinedObjectType.CONTACTUS
            };
        ...
        //add contact us
        //private ContactInfo CreateContactUs(string firstName, string lastName, string subscriberEmail)
        //{
        //    var contactUs = new ContactInfo
        //    {
        //        ContactUsFirstName = firstName,
        //        ContactUsLastName = lastName,
        //        ContactUsEmail = subscriberEmail
        //    };
