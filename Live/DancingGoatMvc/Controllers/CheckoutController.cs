...
namespace DancingGoat.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public CheckoutController(IShoppingService shoppingService, IContactRepository contactRepository, IContactUsRepository contactUsRepository, IProductRepository productRepository, 
        ...
        public ActionResult ThankYou()
        {
            ...
            var companyContactUs = contactUsRepository.GetCompanyContact();

            viewModel = new ThankYouViewModel
            {
                Phone = companyContactUs.Phone
