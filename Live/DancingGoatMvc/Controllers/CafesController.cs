...
namespace DancingGoat.Controllers
{
    public class CafesController : Controller
    {
        ...
        //ContactUs Code
        //private Dictionary<string, List<ContactUsViewModel>> GetPartnerCafesModel(IEnumerable<Cafe> cafes)
        //{
        //    var cityCafes = new Dictionary<string, List<ContactUsViewModel>>();

        //    // Group partner cafes by their location
        //    foreach (var cafe in cafes)
        //    {
        //        var city = cafe.City.ToLowerInvariant();
        //        var contactUs = ContactUsViewModel.GetViewModel(cafe, countryRepository);

        //        if (cityCafes.ContainsKey(city))
        //        {
        //            cityCafes[city].Add(contactUs);
        //        }
        //        else
        //        {
        //            cityCafes.Add(city, new List<ContactViewModel> { contact });
