    ...
    public class ConsentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (consent != null)
            {
                ...
                //var contactUs = ContactUsManagementContext.CurrentContactUs;
                //if ((contactUs != null) && consentAgreementService.IsAgreed(contactUs, consent))
                //{
                //    model.IsConsentAgreed = true;
                //}
        ...
        public ActionResult Agree()
        {
            ...
            if (consent != null)
            {
                ...
                //if (contactUs != null)
                //{
                //    consentAgreementService.Agree(contactUs, consent);
                //}
