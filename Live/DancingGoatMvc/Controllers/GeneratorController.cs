...
namespace DancingGoat.Controllers
{
    ...
    public class GeneratorController : Controller
    {
        ...
        /// <summary>
        /// First name prefix of contactsUs generated for sample campaigns.
        /// </summary>
        private const string CONTACTUS_FIRST_NAME_PREFIX = "GeneratedMvcCampaignContactUs";
        ...
        /// <summary>
        /// Last name prefix of contactsUs generated for sample campaigns.
        /// </summary>
        private const string CONTACTUS_LAST_NAME_PREFIX = "GeneratedMvcCampaignContactUsLastName";
        ...
        public ActionResult Generate()
        {
            ...
            new ContactUsGroupGenerator().Generate();

            new CampaignContactsDataGenerator(CONTACT_FIRST_NAME_PREFIX, CONTACT_LAST_NAME_PREFIX).Generate();
            //new CampaignContactUssDataGenerator(CONTACTUS_FIRST_NAME_PREFIX, CONTACTUS_LAST_NAME_PREFIX).Generate();

            var site = Service.Resolve<ISiteService>().CurrentSite;
            //new CampaignDataGenerator(site, CONTACTUS_FIRST_NAME_PREFIX).Generate();
        ...
        public ActionResult GenerateDataProtectionDemo()
        {
            ...
            // new FormContactUsGroupGenerator().Generate();
